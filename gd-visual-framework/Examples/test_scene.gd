...
static func _static_init() -> void:
	...
	if method:
		script.register_method_tuple_as_dict("does_method_exist", [{"property": "does_exist", "type": TYPE_BOOL, "class_name": ""},\
																   {"property": "attached_to_script", "type": TYPE_OBJECT, "class_name": "Script"}])													
